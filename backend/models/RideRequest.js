...
const rideRequestSchema = new mongoose.Schema(
  {
    ...
    fareRule: {
      ...
      discountBpsPerKm2: Number,
      discountBpsPerKm3: Number,
      discountBpsPerKm4: Number,
      maxDiscountBps: Number,
    },
    finalFarePaisa: { type: Number, default: null },
    currentEstimatePaisa: Number,
    previousEstimatePaisa: Number,
    estimateHistoryPaisa: [Number],
    fareBreakdown: [
      {
        from: String,
        to: String,
