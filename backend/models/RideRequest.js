...
const rideRequestSchema = new mongoose.Schema({
  ...
  status: { type: String, enum: ["REQUESTED", "MATCHED", "DRIVER_ARRIVED", "STARTED", "COMPLETED", "CANCELLED"], default: "REQUESTED", index: true },
...
rideRequestSchema.index({ passenger: 1 }, { unique: true, partialFilterExpression: { status: { $in: ["REQUESTED", "MATCHED", "DRIVER_ARRIVED", "STARTED"] } } });
